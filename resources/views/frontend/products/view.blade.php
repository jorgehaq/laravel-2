                ...
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        @if($products->trending=='1')
                            <label style="font-size: 16px;" class="float-end bagde bg-danger trending_tag" for="">Trending</label>
                        @endif
                    </h2>
                    <hr>
                    ...
                    @else
                        <label class="bagde bg-danger">Out Stock</label>
                    @endif
                    <div class="row mt-2">
                        <div class="col-md-4">
                            ...
                            <div class="input-group text-center mb-3">
                                ...
                                <input type="text" name="quantity" value="1" style="width: 10px;" class="form-control"/>
                                <span class="input-group-text">+</span>
                            </div>
                        </div>
                        <div class="col-md-6">
